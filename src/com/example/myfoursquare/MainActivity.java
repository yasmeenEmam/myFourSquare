...
public class MainActivity extends Activity {
     ...
     */
    private static final String CLIENT_ID = "T4TPMZOKYXPMLVNQEQGZFHYCOFM21YKW425HZ3UMRKRWSU4A";
    private static final String CLIENT_SECRET = "UXOQG0GCTF3JKX4VOO0U2YNQH2X1PY2SI31CDLQMMMSA3AXO";
    Button to_map;Button btnLogin;
    ...
    private void ensureUi() {
        ...
        to_map.setVisibility(View.INVISIBLE);
        ...
        btnLogin.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (FoursquareOAuth.isPlayStoreIntent(intent)) {
                    toastMessage(MainActivity.this, "app_not_installed_message");
    ...
    private void onCompleteTokenExchange(int resultCode, Intent data) {
        ...
        if (exception == null) {
            ...
            to_map.setVisibility(View.VISIBLE);
            btnLogin.setVisibility(View.INVISIBLE);
            to_map.setOnClickListener(new OnClickListener() {
    			
    			@Override
    			public void onClick(View v) {
    				Intent mIntent = new Intent(MainActivity.this, map.class);
